...
interface RowModelUpdate extends GridRowData {
 ...
 * The full grid API.
 */
declare type GridApi = GridCoreApi & ComponentsApi & GridStateApi & GridDensityApi & GridEventsApi & GridRowApi & GridColumnApi & ColumnReorderApi & GridSelectionApi & GridSortApi & GridVirtualizationApi & GridPaginationApi & GridCsvExportApi & FilterApi & ColumnMenuApi & ColumnResizeApi & PreferencesPanelApi & LocaleTextApi;
...
declare const filterGridColumnLookupSelector: OutputSelector<GridState, Record<string, GridFilterItem[]>, (res: GridFilterItem[]) => Record<string, GridFilterItem[]>>;
...
declare const gridRowsLookupSelector: OutputSelector<GridState, Record<GridRowId, GridRowModel>, (res: InternalGridRowsState) => Record<GridRowId, GridRowModel>>;
...
declare const gridSelectionStateSelector: (state: GridState) => Record<GridRowId, boolean>;
...
declare const sortedGridRowsSelector: OutputSelector<GridState, GridRowModel[], (res1: GridRowId[], res2: Record<GridRowId, GridRowModel>, res3: GridRowModel[]) => GridRowModel[]>;
...
declare const gridSortColumnLookupSelector: OutputSelector<GridState, Record<string, {
    sortDirection: GridSortDirection;
    sortIndex?: number | undefined;
}>, (res: GridSortModel) => Record<string, {
    sortDirection: GridSortDirection;
    sortIndex?: number | undefined;
}>>;
...
declare function buildGridCellParams({ element, value, rowIndex, rowModel, colDef, api, }: {
...
declare const DataGrid: MemoExoticComponent<ForwardRefExoticComponent<Pick<GridComponentProps, "autoHeight" | "rowHeight" | "headerHeight" | "scrollbarSize" | "columnBuffer" | "disableColumnFilter" | "disableColumnMenu" | "disableDensitySelector" | "disableColumnSelector" | "showCellRightBorder" | "showColumnRightBorder" | "disableExtendRowFullWidth" | "sortingOrder" | "pageSize" | "autoPageSize" | "rowsPerPageOptions" | "paginationMode" | "rowCount" | "page" | "sortingMode" | "filterMode" | "hideFooter" | "hideFooterRowCount" | "hideFooterSelectedRowCount" | "hideFooterPagination" | "checkboxSelection" | "disableSelectionOnClick" | "logger" | "logLevel" | "sortModel" | "filterModel" | "selectionModel" | "onCellClick" | "onCellHover" | "onRowClick" | "onRowHover" | "onRowSelected" | "onSelectionModelChange" | "onColumnHeaderClick" | "onSortModelChange" | "onFilterModelChange" | "onPageChange" | "onPageSizeChange" | "onError" | "onStateChange" | "columnTypes" | "density" | "localeText" | "columns" | "components" | "componentsProps" | "className" | "error" | "nonce" | "loading" | "rows" | "state" | "getRowId"> & {
